<template>
	<div class="diy_details_box diy_div_reward_and_punishment_information">
		<div class="warp">
			<div class="container">
	...
	export default {
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					source_table: "reward_and_punishment_information",
					source_field: "reward_and_punishment_information_id",
					source_id: this.obj["reward_and_punishment_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/reward_and_punishment_information/set?reward_and_punishment_information_id=' + _this.obj["reward_and_punishment_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
