<template>
	<div class="diy_home diy_list diy_salary_information" id="diy_salary_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/salary_information/details?salary_information_id=' + o['salary_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/salary_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/salary_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','achievements')">绩效
					</th>
					<th class="diy_title" v-if="$check_field('get','basic_salary')">基础工资
					</th>
					<th class="diy_title" v-if="$check_field('get','total_wages')">工资总额
					</th>
					<th class="diy_title" v-if="$check_field('get','month')">月份
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_number" v-if="$check_field('get','achievements')">
						<span>
							{{ o["achievements"] }}
						</span>
					</td>
					<td class="diy_field diy_number" v-if="$check_field('get','basic_salary')">
						<span>
							{{ o["basic_salary"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','total_wages')">
						<span>
							{{ o["total_wages"] }}
						</span>
					</td>
