		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','contract_signing_date')">合同签订日期
					</th>
					<th class="diy_title" v-if="$check_field('get','contract_end_date')">合同结束日期
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_date" v-if="$check_field('get','contract_signing_date')">
						<span>
							{{ $toTime(o["contract_signing_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
					<td class="diy_field diy_date" v-if="$check_field('get','contract_end_date')">
						<span>
							{{ $toTime(o["contract_end_date"] ,"yyyy-MM-dd") }}
						</span>
					</td>
				</tr>
			</table>
