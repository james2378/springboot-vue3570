<template>
	<div class="diy_details page_training_information" id="training_information_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_training_information'>
							<div_training_information :obj="obj"></div_training_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_training_information from "@/components/diy/div_training_information.vue";
	import mixin from "@/mixins/page.js";
	export default {
		mixins:[mixin],
		components:{
			div_training_information
		},
		data(){
			return{
		...
		methods:{
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "training_information",
					source_field: "training_information_id",
					source_id: obj["training_information_id"],
					user_id
				};
		 ...
		 /****
			...
			change_collect() {
				...
				var query = {
					source_table: "training_information",
					source_field: "training_information_id",
					source_id: this.obj["training_information_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/training_information/set?training_information_id=' + _this.obj["training_information_id"], {
								praise_len
							}, (res) => {
								if(res.result){
