...
const routes = [
	...
	// 合同信息路由
	{
		path: '/contract_information/table',
		name: 'contract_information_table',
		component: () => import('../views/contract_information/table.vue')
	},
	{
		path: '/contract_information/view',
		name: 'contract_information_view',
		component: () => import('../views/contract_information/view.vue')
	},
	// 员工用户路由
	{
	...
	// 考勤信息路由
	{
		path: '/attendance_information/table',
		name: 'attendance_information_table',
		component: () => import('../views/attendance_information/table.vue')
	},
	{
		path: '/attendance_information/view',
		name: 'attendance_information_view',
		component: () => import('../views/attendance_information/view.vue')
	},
	// 薪资信息路由
	{
	...
	// 离职信息路由
	{
		path: '/resignation_information/table',
		name: 'resignation_information_table',
		component: () => import('../views/resignation_information/table.vue')
	},
	{
		path: '/resignation_information/view',
		name: 'resignation_information_view',
		component: () => import('../views/resignation_information/view.vue')
	},
	// 奖罚信息路由
	{
