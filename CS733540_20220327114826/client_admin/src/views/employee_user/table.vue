	...
	<el-main class="bg">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/employee_user/table','add') || $check_action('/employee_user/view','add')" class="el-button el-button--default el-button--primary" to="./view?">添加
						</router-link>
						<el-button v-if="user_group == '管理员' || $check_action('/employee_user/table','del') || $check_action('/employee_user/view','del')" class="" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="salary" label="薪资"
				v-if="user_group == '管理员' || $check_field('get','salary')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/employee_user/table','set') || $check_action('/employee_user/view','set') || $check_action('/employee_user/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
